...
public class ConnectTwoRopesTest {
    ...
    public void throws_exception_for_null_ropes_array_input() {
        ...
        try {
            ...
            assertEquals(connectTwoRopesSolver.getInvalidArrayInputError(), e.getMessage());
        }
    }
    ...
    public void throws_exception_for_negative_ropes_array_lengths() {
        ...
        try {
            ...
            assertEquals(connectTwoRopesSolver.getNonNegativeArrayIndexError(), e.getMessage());
        }
    }

...
import modules.algorithmic_toolbox.week_3.assignments.MaximumSalaryConstructor;
...
class MaximumSalaryConstructorTest {
    private MaximumSalaryConstructor maximumSalaryConstructorSolver;

    @BeforeEach
    void setUp() {
        maximumSalaryConstructorSolver = new MaximumSalaryConstructor();
    }
    ...
    public void maximize_salary_returns_correct_value_with_single_element_input_array() {
        ...
        Assertions.assertEquals(new BigInteger("578"), maximumSalaryConstructorSolver.constructLargestNumber(digits));
    }
    ...
    public void maximize_salary_returns_correct_value_with_single_zero_element_input_array() {
        ...
        Assertions.assertEquals(BigInteger.ZERO, maximumSalaryConstructorSolver.constructLargestNumber(digits));
    }
    ...
    public void maximize_salary_returns_correct_value_with_only_single_digit_inputs() {
        ...
        Assertions.assertEquals(new BigInteger("987521"), maximumSalaryConstructorSolver.constructLargestNumber(digits));
    }
    ...
    public void maximize_salary_returns_correct_value_with_varied_length_digits_in_input_array() {
        ...
        Assertions.assertEquals(new BigInteger("5815756955513242532525172342212211"), maximumSalaryConstructorSolver.constructLargestNumber(digits));
    }

    @Test
    public void maximize_salary_throws_null_pointer_exception_with_null_input_parameters() {
        try {
            maximumSalaryConstructorSolver.constructLargestNumber(null);
    ...
    public void maximize_salary_throws_illegal_argument_exception_for_negative_values_in_the_input_array() {
        ...
        try {
            maximumSalaryConstructorSolver.constructLargestNumber(digits);

...
import static week_4.lectures.recursion.Fibonacci.NEGATIVE_INDEX_VALIDATION_ERROR_MESSAGE;
...
class FibonacciTest {
    ...
    public void throws_exception_for_negative_values() {
        ...
        try {
            ...
            assertEquals(NEGATIVE_INDEX_VALIDATION_ERROR_MESSAGE, e.getMessage());
        }
    }

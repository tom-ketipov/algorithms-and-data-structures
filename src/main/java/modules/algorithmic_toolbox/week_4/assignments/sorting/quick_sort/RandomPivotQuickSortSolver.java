...
public class RandomPivotQuickSortSolver extends BaseSolver {
    ...
    /**
     * Sorts the elements of the specified array between the given indices using a quicksort algorithm.
     *
    ...
    private void sort(int[] arr, int left, int right) {
        ...
        int m = generateNumberInRange(left, right);

...
public class SelectionSort {
    ...
    private void sort(int[] array, int startIndex) {
        ...
        Validate.inclusiveBetween(minValue, maxValue, startIndex, ValidationMessageUtility.getMessage("value_range_exception", minValue, maxValue));
    ...
    private void swap(int[] array, int indexA, int indexB) {
        ...
        Validate.inclusiveBetween(minValue, maxValue, indexA, ValidationMessageUtility.getMessage("value_range_exception", minValue, maxValue));
        Validate.inclusiveBetween(minValue, maxValue, indexB, ValidationMessageUtility.getMessage("value_range_exception", minValue, maxValue));

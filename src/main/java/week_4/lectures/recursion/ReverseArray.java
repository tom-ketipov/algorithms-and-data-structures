...
public class ReverseArray {
    public static final String NULL_ARRAY_EXCEPTION_MESSAGE = "Array cannot be null.";
     ...
     * @throws IllegalArgumentException if the input array is null.
     */
    private void validateNotNull(int[] arr) {
        if (arr == null) {
            throw new IllegalArgumentException(NULL_ARRAY_EXCEPTION_MESSAGE);
        }
    }
}
